...
function TurnRenWu(){
    click(random(440,639),random(1810,1920));//440,1810,639,1920
}

function TurnShiPin(){
    click(random(220,419),random(1810,1920))//660,1810,859,1920
}
...
function ADClose(){
    ...
    if(className("android.widget.ImageView").boundsInside(900, 60, 1100, 200).findOne()){//右上交关闭 
        ...
        click(X+random(-2,2),Y+random(-2,2));
    }
    console.show();
...
function OpenBox(){
    if(className("android.widget.TextView").text("开宝箱得金币").exists()){
        click(random(850,1084),random(1443,1627))
